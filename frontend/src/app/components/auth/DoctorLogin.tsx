...
export default function DoctorLogin() {
  ...
  function fillDemo() { setPhone("9000000001"); setPassword("doctor123"); }
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pt-20 z-10">
        ...
        >
          <div className="text-center mb-10">
            <div className="w-16 h-16 bg-[#32d74b] rounded-[1.25rem] flex items-center justify-center mx-auto mb-8 shadow-[0_0_40px_rgba(50,215,75,0.3)]">
              <Stethoscope className="w-8 h-8 text-black" />
            </div>
            <h1 className="text-3xl font-semibold tracking-tight mb-2 text-white">Clinical Portal</h1>
            <p className="text-base text-[#86868b] font-medium tracking-tight">
              Sign in with your provider ID.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-6">
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex items-center justify-center gap-2 py-4 rounded-full font-semibold text-[17px] transition-all ${loading ? "bg-[#2c2c2e] text-[#86868b] cursor-not-allowed" : "bg-[#32d74b] text-black hover:scale-[1.02] active:scale-[0.98]"}`}
              >
                {loading ? (
            ...
            <div className="text-center pt-4">
              <button
                type="button"
                onClick={fillDemo}
                className="text-sm text-[#32d74b] hover:underline font-medium"
              >
